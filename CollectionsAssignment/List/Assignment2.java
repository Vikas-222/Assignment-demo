...
//        compare between two students name and print in descending order
        Comparator<Student> compare = (stud1, stud2) -> stud2.getSname().compareTo(stud1.getSname());
...
//        To search with Binary search method list must be in sorted order
        ...
        System.out.println(nameList);
        System.out.println(find+" find at "+Collections.binarySearch(nameList, find)+" th position");
    }
}
